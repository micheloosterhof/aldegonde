...
| [dual-autokey-lag1-lag5.md](dual-autokey-lag1-lag5.md) | Dual Autokey: Lag-1 Ciphertext plus Lag-5 Plaintext | closed (Aug 2026, Michel's proposal): escapes the grouped-IoC test that kills pure ciphertext autokey (1.046 vs 1.756), but the doublet suppression is not structural and linear feedback lets at most one distance carry a clean relation while the LP needs four -- floors ~1.4x short on depth (0.86% vs 0.63%) and produces no d5 echo |
