...
| [d5-partial-alphabet-leak.md](d5-partial-alphabet-leak.md) | The d5 Echo is a Same-Alphabet Leak (order-5 g confirmed; phi5 still open) | partial (Aug 2026): d3/d4 controls sit at chance (z vs plaintext −5.9, −3.7) while d5 reads plaintext, so one-alphabet-per-word is REFUTED and g has order exactly 5; phi5 itself remains underpowered at 0.64–0.71, convention-dependent |
