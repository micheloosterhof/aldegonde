...
| [magic-square-grid-key.md](magic-square-grid-key.md) | `g` From the Book's Own 5×5 Magic Square (constant 3301) | REFUTED (Aug 2026): 190,008 candidates give 1 survivor of the seven distance cuts against 2.4 expected by chance -- no enrichment over random order-5 permutations |
