...
| Within-word d=5 echo by rune | S: 11 pairs; next rune 7 | 1.75 (S); ~2.5 (others) | The d=5 excess is carried disproportionately by one rune, S (Sigel): p=2.4e-6, Bonferroni-clean, distance-5-specific, within-word only, ~22% of the excess; see `rune-s-lag5-echo.md`, `experiments/rune_s_lag5.py` |
